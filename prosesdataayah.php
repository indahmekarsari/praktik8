...
include 'koneksidb.php';
    if (isset($_POST['submit'])) {
        ...
        $bekerayah = $_POST['bekerayah'];

      // Menyimpan ke database
      $sql = mysqli_query($conn, "INSERT INTO dataayah (namaayah, tlayah, pendayah, pekerayah, salaryayah, bekerayah) VALUES ('$namaayah', '$tlayah', '$pendayah', '$pekerayah', '$salaryayah', '$berkebayah')");
      if ($sql) {
